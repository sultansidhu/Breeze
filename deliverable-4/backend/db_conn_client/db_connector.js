...
/**
 * Connecting to the database via terminal (psql):
 * psql --host=breeze-technologies.postgres.database.azure.com --port=5432 
 * --username=breezetechs@breeze-technologies --dbname=postgres
 * 
 */